...
public final class UiUtils {
  ...
  public static final DateTimeFormatter SANE_DATE_TIME_FORMAT = DateTimeFormat.forPattern("MMM dd, yyyy hh:mma z");
  ...
  public static String getDateTimeString(StubHubResponse.Event nextEvent) {
    Preconditions.checkNotNull(nextEvent, "Event cannot be null.");
    DateTime dateTime = STUB_HUB_DATE_TIME_FORMAT.parseDateTime(nextEvent.getEventDate());
    return SANE_DATE_TIME_FORMAT.print(dateTime);
  }

  public static long getDateTimeAsEpoch(StubHubResponse.Event nextEvent) {
    Preconditions.checkNotNull(nextEvent, "Event cannot be null.");
    DateTime dateTime = STUB_HUB_DATE_TIME_FORMAT.parseDateTime(nextEvent.getEventDate());
